...
var text_encoding_1 = __webpack_require__(5);
var ChannelMessageUtils = (function () {
    ...
    ChannelMessageUtils.serializeChannelMessage = function (messageInfo, lastTimestampSent, clockSkew) {
        ...
        if (messageInfo.controlMessagePayload) {
            ...
            if (messageInfo.controlMessagePayload.jsonMessage) {
                jsonPayloadBuffer = new text_encoding_1.TextEncoder().encode(JSON.stringify(messageInfo.controlMessagePayload.jsonMessage));
    ...
    ChannelMessageUtils.parseChannelMessage = function (message) {
        var result = {
            rawMessage: message,
            valid: false
        };
        ...
        if (result.info.channelCode === 0 && result.info.senderCode === 0) {
            ...
            try {
                var jsonString = new text_encoding_1.TextDecoder("utf-8").decode(message.subarray(this.MESSAGE_HEADER_LENGTH + 4, this.MESSAGE_HEADER_LENGTH + 4 + jsonLength));
...
var TransportManager = (function () {
    ...
    TransportManager.prototype.sendControl = function (messageId, info, type, details, callback) {
        if (info && info.connected) {
            ...
            var bytes = interfaces_1.ChannelMessageUtils.serializeControlMessage(messageId, type, details);
    ...
    TransportManager.prototype.send = function (channelId, message) {
        var info = this.socketsById[channelId];
        if (info && info.connected) {
            var bytes = interfaces_1.ChannelMessageUtils.serializeChannelMessage(message, 0, 0);
            info.socket.send(bytes.buffer);
        }
        else {
    ...
    TransportManager.prototype.onMessageReceived = function (info, event) {
        ...
        if (data) {
            ...
            var parsed = interfaces_1.ChannelMessageUtils.parseChannelMessage(new Uint8Array(buffer));
...
(function(global) {
  ...
  if (typeof module !== "undefined" && module.exports &&
    !global["encoding-indexes"]) {
    global["encoding-indexes"] =
      __webpack_require__(6)["encoding-indexes"];
  }
...
var transport_manager_1 = __webpack_require__(3);
...
var ChannelsClientImpl = (function () {
    ...
    ChannelsClientImpl.prototype.connectTransport = function (registryUrl, channelId, url) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ChannelsClientImpl.prototype.joinChannel = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var payload = new TextEncoder().encode(messageText);
                        var messageInfo = {
